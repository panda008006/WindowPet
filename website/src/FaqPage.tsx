...
export function FaqPage({ onBackToHome, onOpenCustom, onOpenGallery }: FaqPageProps) {
  ...
  const faqGroups = [
    ...
    },
    {
      ...
      items: [
        {
          q: '小鼻嘎展馆里的所有 21 款角色模型都是免费的吗？需要充值吗？',
          a: '100% 永久免费！所有展馆内的角色均附带了公开兑换码，免登录直接使用，无任何付费抽卡（没有 UR/SSR 区分）或强制内购广告。',
        },
        {
          q: '展馆里的动漫和热梗角色会不会有版权风险？',
          a: 'WindowPet 坚持中立技术平台与“避风港原则（Safe Harbor）”。展馆中的动漫同人与表情包角色均由民间爱好者自发制作并署名分享（UGC 二创模式），仅供个人本地学习与美化交流，绝不从事任何商业销售。如版权方提出异议，我们将在 24 小时内即刻执行下架处理。',
        },
        {
